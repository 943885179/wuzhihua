...
namespace common
{
    ...
    public abstract class SqlHelp
    {
        ...
        {
            return ExecuteScalar(SqlHelp.connectionString, cmdType, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(SqlHelp.connectionString, CommandType.StoredProcedure, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(SqlHelp.connectionString, CommandType.Text, cmdText, commandParameters);
        }
