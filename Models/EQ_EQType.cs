...
namespace Models
{
    ...
    public partial class EQ_EQType
    {
        public int AutoID { get; set; }
        public string cEQTypeCode { get; set; }
        public string cEQTypeName { get; set; }
        public string cgg { get; set; }
        public string cxh { get; set; }
        public string cLBCode { get; set; }
        public Nullable<double> dblJX { get; set; }
        public Nullable<double> dblDQ { get; set; }
        public int intJM { get; set; }
        public int intDX { get; set; }
        public int intXY { get; set; }
        public int intTZ { get; set; }
        public int intChange { get; set; }
