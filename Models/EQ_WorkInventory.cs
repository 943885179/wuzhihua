...
namespace Models
{
    ...
    public partial class EQ_WorkInventory
    {
        ...
        public Nullable<double> fFactPrice { get; set; }
        public Nullable<double> fFactNum { get; set; }
        public Nullable<int> intRef { get; set; }
