...
namespace Models
{
    ...
    public partial class sfc_workhrnotereason
    {
        public int WorkHrReasonDId { get; set; }
        public Nullable<int> WorkHrSumId { get; set; }
        ...
        public virtual sfc_workhrnotesum sfc_workhrnotesum { get; set; }
    }
}
