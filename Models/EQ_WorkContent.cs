...
namespace Models
{
    ...
    public partial class EQ_WorkContent
    {
        public int AutoID { get; set; }
        public string cWorkConCode { get; set; }
        public string cWorkConName { get; set; }
        ...
        public string cDtCom { get; set; }
        public Nullable<int> intTime { get; set; }
        public Nullable<int> intExecTime { get; set; }
