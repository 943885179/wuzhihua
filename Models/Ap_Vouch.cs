...
namespace Models
{
    ...
    public partial class Ap_Vouch
    {
        ...
        public string cPluginsourcetype { get; set; }
        public Nullable<long> iPluginsourceautoid { get; set; }
        public string cPluginsourceautoid { get; set; }
