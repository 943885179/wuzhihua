...
namespace Models
{
    ...
    public partial class FM_Fetch
    {
        public int autoID { get; set; }
        public string strFetchID { get; set; }
        public string bType { get; set; }
        public string strDepositID { get; set; }
        public System.DateTime dtDate { get; set; }
        public decimal dblQbje { get; set; }
        public Nullable<decimal> dblsybje { get; set; }
        public decimal dblqlxe { get; set; }
        public decimal dblFetch { get; set; }
