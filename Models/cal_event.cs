...
namespace Models
{
    ...
    public partial class cal_event
    {
        ...
        public cal_event()
        {
            this.cal_cancel = new HashSet<cal_cancel>();
            this.cal_reply = new HashSet<cal_reply>();
        }
        ...
        public byte alarm_flag { get; set; }
        ...
        public virtual ICollection<cal_cancel> cal_cancel { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<cal_reply> cal_reply { get; set; }
    }
}
