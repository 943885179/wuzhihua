...
namespace Models
{
    ...
    public partial class GSP_VOUCHCARDS
    {
        public int AUTOID { get; set; }
        public int ID { get; set; }
        public Nullable<System.DateTime> DINSPECTDATE_T { get; set; }
        public string CRECORDID { get; set; }
        public string CCONDITION { get; set; }
        public string CRESULT_T { get; set; }
        public string CUNIT_T { get; set; }
        public string CINSPECTER_T { get; set; }
        public string CITEM { get; set; }
        public Nullable<System.DateTime> DNEXTDATE { get; set; }
