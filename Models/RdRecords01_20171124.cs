...
namespace Models
{
    ...
    public partial class RdRecords01_20171124
    {
        ...
        public Nullable<long> iPOsID { get; set; }
        ...
        public Nullable<long> iArrsId { get; set; }
        ...
        public Nullable<int> iOldPartId { get; set; }
        public Nullable<decimal> fOldQuantity { get; set; }
        public string cbsysbarcode { get; set; }
        public Nullable<bool> bmergecheck { get; set; }
        public Nullable<int> iMergeCheckAutoId { get; set; }
        public Nullable<byte> bnoitemused { get; set; }
        public string cReworkMOCode { get; set; }
        public Nullable<int> iReworkMODetailsid { get; set; }
        public Nullable<int> iProductType { get; set; }
        public string cMainInvCode { get; set; }
        public Nullable<int> iMainMoDetailsID { get; set; }
        public Nullable<decimal> iShareMaterialFee { get; set; }
