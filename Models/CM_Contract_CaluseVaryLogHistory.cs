...
namespace Models
{
    ...
    public partial class CM_Contract_CaluseVaryLogHistory
    {
        public int ID { get; set; }
        public System.Guid GUID { get; set; }
        public string strCaluseClass { get; set; }
        public string strName_Caluse { get; set; }
        public string strMemo_Caluse { get; set; }
