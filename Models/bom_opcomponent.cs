...
namespace Models
{
    ...
    public partial class bom_opcomponent
    {
        ...
        {
            this.bom_opcomponentloc = new HashSet<bom_opcomponentloc>();
            this.bom_opcomponentsub = new HashSet<bom_opcomponentsub>();
        }
        ...
        public Nullable<bool> RecursiveFlag { get; set; }
        ...
        public virtual ICollection<bom_opcomponentloc> bom_opcomponentloc { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
