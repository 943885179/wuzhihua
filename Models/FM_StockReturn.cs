...
namespace Models
{
    ...
    public partial class FM_StockReturn
    {
        public int autoID { get; set; }
        public string strStockReturnID { get; set; }
        public string bType { get; set; }
        public System.DateTime dtDate { get; set; }
        public string strUnitCode { get; set; }
        public decimal dblPerFinMon { get; set; }
        public decimal dblPerCash { get; set; }
        public decimal dblReMon { get; set; }
        public decimal dblLeave { get; set; }
        public Nullable<decimal> dblReGle { get; set; }
        public decimal dblJqgle { get; set; }
