...
namespace Models
{
    ...
    public partial class ST_SNAdjustVouchs
    {
        public int autoid { get; set; }
        public Nullable<int> id { get; set; }
        public string cinvcode { get; set; }
        public string cpreinvsn { get; set; }
        public Nullable<short> ipreinvsnstate { get; set; }
        public string cpostinvsn { get; set; }
        public Nullable<short> ipostinvsnstate { get; set; }
        ...
        public Nullable<byte> imassunit { get; set; }
