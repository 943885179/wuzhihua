...
namespace Models
{
    ...
    public partial class GSP_VOUCHPHONEXPVS
    {
        public int AUTOID { get; set; }
        public string SERIALNUMBER { get; set; }
        public string CDEPARTMENT { get; set; }
        public string CCONTENT { get; set; }
        public string CQUANT { get; set; }
        public string CFINISH { get; set; }
        public string CEXPONENT { get; set; }
        public string CMEASURE { get; set; }
        public string CSYNDEPCODE { get; set; }
        public string CTEMPOREQ { get; set; }
        public string CCHKDEPCODE { get; set; }
