...
namespace Models
{
    ...
    public partial class hr_hi_subsidy
    {
        public System.Guid PK_hr_hi_subsidy { get; set; }
        ...
        public Nullable<decimal> nCommunFee { get; set; }
        public Nullable<decimal> nErrandSubsidyFee { get; set; }
