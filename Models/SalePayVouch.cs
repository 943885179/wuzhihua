...
namespace Models
{
    ...
    public partial class SalePayVouch
    {
        ...
        public string cExpType { get; set; }
        public string cProActiveCode { get; set; }
        public string cVerifier { get; set; }
        public string coppcode { get; set; }
        public Nullable<int> ioppcourseid { get; set; }
        ...
        public string cassessor { get; set; }
        ...
        public string cNECostApplyID { get; set; }
        public string cNECostApplyCode { get; set; }
        public Nullable<int> actvt_id { get; set; }
