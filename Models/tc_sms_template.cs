...
namespace Models
{
    ...
    public partial class tc_sms_template
    {
        public decimal tmpl_id { get; set; }
        public Nullable<short> is_sys { get; set; }
        public Nullable<short> tmpl_status { get; set; }
        public Nullable<decimal> tmpl_cat { get; set; }
        public string tags { get; set; }
        public string tmpl_code { get; set; }
        public string tmpl_name { get; set; }
        public Nullable<short> has_replace { get; set; }
        public Nullable<short> is_public { get; set; }
        public string tmpl_note { get; set; }
