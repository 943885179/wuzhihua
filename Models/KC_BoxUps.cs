...
namespace Models
{
    ...
    public partial class KC_BoxUps
    {
        ...
        public Nullable<decimal> iDueQty { get; set; }
        public Nullable<decimal> iQuantity { get; set; }
        public Nullable<decimal> iUnBoxQty { get; set; }
        public Nullable<decimal> iDueNum { get; set; }
        public Nullable<decimal> iNum { get; set; }
        public Nullable<decimal> iUnBoxNum { get; set; }
        public Nullable<byte> bAllUnBoxed { get; set; }
        ...
        public Nullable<byte> bVMIUsed { get; set; }
        public string cbSource { get; set; }
        public string cSourceCode { get; set; }
        public Nullable<long> iSourceIds { get; set; }
        public Nullable<int> iSourceRowNO { get; set; }
        ...
        public Nullable<long> iInsID { get; set; }
        public Nullable<long> iOutsID { get; set; }
        ...
        public Nullable<int> CabStatus { get; set; }
    }
}
