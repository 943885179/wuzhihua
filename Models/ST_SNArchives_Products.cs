...
namespace Models
{
    ...
    public partial class ST_SNArchives_Products
    {
        public int Autoid { get; set; }
        public string cInvCode { get; set; }
        public Nullable<int> iUseQuantity { get; set; }
        ...
        public string autoid2 { get; set; }
        public Nullable<byte> binvbatch { get; set; }
        public Nullable<byte> binvsn { get; set; }
    }
}
