...
namespace Models
{
    ...
    public partial class tc_consuming_habit
    {
        public decimal habit_id { get; set; }
        public string name { get; set; }
        public string description { get; set; }
        public Nullable<short> product_source { get; set; }
        public string account_cond { get; set; }
        public string contract_cond { get; set; }
        public string asset_cond { get; set; }
        public string account_enum_attrs { get; set; }
        public string product_enum_attrs { get; set; }
