...
namespace Models
{
    ...
    public partial class FM_Stock
    {
        public int autoID { get; set; }
        public string strStockID { get; set; }
        public string bStatus { get; set; }
        public string bType { get; set; }
        public System.DateTime dtDate { get; set; }
        public string strUnitCode { get; set; }
        public decimal dblFinMon { get; set; }
        public Nullable<decimal> dblPerFinMon { get; set; }
        public Nullable<decimal> dblFactMon { get; set; }
        public Nullable<decimal> dblPerFactMon { get; set; }
