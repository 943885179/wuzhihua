...
namespace Models
{
    ...
    public partial class hr_hi_workqualify
    {
        public System.Guid PK_hr_hi_workqualify { get; set; }
        ...
        public string rqualifyName { get; set; }
        public string rqualifyLev { get; set; }
