...
namespace Models
{
    ...
    public partial class NE_ExpenVouch
    {
        ...
        public Nullable<System.DateTime> HXDate { get; set; }
        public Nullable<int> UAPRuntime_RowNO { get; set; }
        public Nullable<System.Guid> CostApplyID { get; set; }
        public Nullable<decimal> CRMApplyMoney { get; set; }
        public string CRMActionID { get; set; }
        ...
        public string RedOperationTypeCode { get; set; }
        public Nullable<System.Guid> RedVouchID { get; set; }
        public int IsRedVouch { get; set; }
        public int IsErrorFlag { get; set; }
        public int IsRedVerifyed { get; set; }
        ...
        public string CostApplyCode { get; set; }
        public Nullable<decimal> ApplyExpensedMoney { get; set; }
        public Nullable<decimal> ApplyExpensedLocalMoney { get; set; }
        public Nullable<decimal> PreVerifyMoney { get; set; }
        public Nullable<decimal> PreVerifyLocalMoney { get; set; }
        public Nullable<decimal> PreMidVerifyMoney { get; set; }
        ...
        public Nullable<decimal> CostThirdPartMoney { get; set; }
        public Nullable<decimal> CostThirdPartLocalMoney { get; set; }
