...
namespace Models
{
    ...
    public partial class FM_NBHKD
    {
        public int autoid { get; set; }
        public string cBillCode { get; set; }
        public string cLinkCode { get; set; }
        public System.DateTime dtHKDate { get; set; }
        public string cDepCode { get; set; }
        public string cYWCode { get; set; }
        public Nullable<int> iCV { get; set; }
        public string cCusCode { get; set; }
        public decimal dblReturn { get; set; }
        public decimal dblFact { get; set; }
        public Nullable<decimal> dblBPCB { get; set; }
        public Nullable<decimal> dblBPSR { get; set; }
