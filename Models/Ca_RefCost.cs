...
namespace Models
{
    ...
    public partial class Ca_RefCost
    {
        public Nullable<int> iRefID { get; set; }
        ...
        public Nullable<double> fRCost { get; set; }
        public Nullable<decimal> fQua { get; set; }
        public byte iRefType { get; set; }
    }
}
