...
namespace Models
{
    ...
    public partial class GSP_VOUCHQUARTERASTS
    {
        public int AUTOID { get; set; }
        public string CBEASSDEPCODE { get; set; }
        public string CASSESSITEM { get; set; }
        public Nullable<int> IITEMSN { get; set; }
        public string CSTANDARDCENT { get; set; }
        public string CQUESTION { get; set; }
        public string CDEDUCT { get; set; }
        public string CENDEPADVICE { get; set; }
