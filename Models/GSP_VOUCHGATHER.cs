...
namespace Models
{
    ...
    public partial class GSP_VOUCHGATHER
    {
        ...
        public string CMANDEP { get; set; }
        public string CCOMFIRMER { get; set; }
        public Nullable<decimal> FQTY { get; set; }
        public Nullable<decimal> FAMPQTY { get; set; }
        public string CDATERANGE { get; set; }
        public Nullable<int> IDAY { get; set; }
        public string CREASON { get; set; }
        public string CEMPHASE { get; set; }
        public string CQSUGGEST { get; set; }
        public string CQER { get; set; }
        public string CSSUGGEST { get; set; }
