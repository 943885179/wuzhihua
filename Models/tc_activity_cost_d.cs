...
namespace Models
{
    ...
    public partial class tc_activity_cost_d
    {
        public decimal actvt_cost_d_id { get; set; }
        public string cost_class_id { get; set; }
        public Nullable<decimal> actvt_id { get; set; }
        public Nullable<decimal> cost_amount { get; set; }
        public Nullable<decimal> approved_cost_amount { get; set; }
        public decimal cost_volume { get; set; }
