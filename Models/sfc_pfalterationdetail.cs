...
namespace Models
{
    ...
    public partial class sfc_pfalterationdetail
    {
        public int PFAlterationDId { get; set; }
        public Nullable<int> PFAlterationId { get; set; }
        public Nullable<int> SortSeq { get; set; }
        public Nullable<int> RelPFId { get; set; }
