...
namespace Models
{
    ...
    public partial class hr_om_reEnter
    {
        public System.Guid PK_hr_om_reEnter { get; set; }
        public string cVoucherType { get; set; }
        public string cVoucherId { get; set; }
        public string cPsn_Name { get; set; }
        public string cPrePsnNum { get; set; }
        public string rSex { get; set; }
        public string dApplyDate { get; set; }
        ...
        public string cPreDepName { get; set; }
        public string cPreJobcode { get; set; }
        public string cPreJobName { get; set; }
        public string cPreJobGradeCode { get; set; }
        public string cPreJobGradeName { get; set; }
        public string cPreJobRankcode { get; set; }
        public string cPreJobRankName { get; set; }
        public string cLeaveReson { get; set; }
        public string dLeaveStartDate { get; set; }
        public string dLeaveEndDate { get; set; }
        public string cReEnterReson { get; set; }
