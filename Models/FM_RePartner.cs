...
namespace Models
{
    ...
    public partial class FM_RePartner
    {
        public int autoID { get; set; }
        public string strRePartnerID { get; set; }
        public string bType { get; set; }
        public System.DateTime dtDate { get; set; }
        public string strUnitCode { get; set; }
        public decimal dblPerInvest { get; set; }
        public decimal dblPerFact { get; set; }
        public decimal dblReMon { get; set; }
        public decimal dblLeaveMon { get; set; }
        public Nullable<decimal> dblReGle { get; set; }
        public Nullable<decimal> dblJcGle { get; set; }
        public Nullable<decimal> dblAllMon { get; set; }
