...
namespace Models
{
    ...
    public partial class GSP_VOUCHDUTYCHECKS
    {
        public int AUTOID { get; set; }
        public string CEXPONENTNAME { get; set; }
        public string CEXPONENT { get; set; }
        public string CFINISH { get; set; }
        public Nullable<decimal> FFINISHRATE { get; set; }
        public string FSTANDARD { get; set; }
        public Nullable<decimal> FANALYSIS { get; set; }
